...
export const setVotingReaction = async (optionId: string, { userId, isChosen }, next): Promise<{}> => {
  return await getCustomRepository(VotingOptionReactionRepository).setVotingReaction(optionId, userId, isChosen, next);
}
