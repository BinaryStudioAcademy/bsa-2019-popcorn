...
router
  ...
  .get('/:id/options', (req, res, next) => votingOptionService.getVotingOptionByVotingId(req.params.id)
    .then(result => res.send(result))
    .catch(next))
  .post('/:id/options', (req, res, next) => votingService.createVotingOptionByVotingId(req.params.id, req.body)
    .then(result => res.send(result))
    .catch(next))
  .put('/options/:id', (req, res, next) => votingOptionService.updateVotingOptionById(req.params.id, req.body)
    .then(result => res.send(result))
    .catch(next))
  .delete('/options/:id', (req, res, next) => votingOptionService.deleteVotingOptionById(req.params.id)
    .then(result => res.send(result))
    .catch(next))
