...
router
  ...
  .get("/:id", errorHandlerMiddleware, (req, res, next) =>
    surveysService
      .getSurveysById(req.params.id, next)
      .then(result => res.send(result))
      .catch(next)
  )
  .delete("/:id", errorHandlerMiddleware, (req, res, next) =>
    surveysService
      .deleteSurveysById(req.params.id, next)
      .then(result => res.send(result))
      .catch(next)
  )
  .put("/:id", errorHandlerMiddleware, (req, res, next) =>
    surveysService
      .updateSurveysById(req.params.id, req.body, next)
      .then(result => res.send(result))
      .catch(next)
  )
  .get("/user/:id", errorHandlerMiddleware, (req, res, next) =>
    surveysService
      .getSurveysByUserId(req.params.id, next)
      .then(result => res.send(result))
      .catch(next)
  )
  ...
  .get("/:id/question", errorHandlerMiddleware, (req, res, next) =>
    surveysQuestionService
      .getSurveysQuestionBySurveysId(req.params.id, next)
      .then(result => res.send(result))
      .catch(next)
  )
  .get("/question/:id", errorHandlerMiddleware, (req, res, next) =>
    surveysQuestionService
      .getSurveysQuestionById(req.params.id, next)
      .then(result => res.send(result))
      .catch(next)
  )
  .put("/question/:id", errorHandlerMiddleware, (req, res, next) =>
    surveysQuestionService
      .updateSurveysQuestionById(req.params.id, req.body, next)
      .then(result => res.send(result))
      .catch(next)
  )
  .delete("/question/:id", errorHandlerMiddleware, (req, res, next) =>
    surveysQuestionService
      .deleteSurveysQuestionById(req.params.id, next)
      .then(result => res.send(result))
      .catch(next)
  )
  ...
  .put("/option/:id", errorHandlerMiddleware, (req, res, next) =>
    surveysQuestionOptionService
      .updateQuestionOptionById(req.params.id, req.body, next)
      .then(result => res.send(result))
      .catch(next)
  )
  .delete("/option/:id", errorHandlerMiddleware, (req, res, next) =>
    surveysQuestionOptionService
      .deleteQuestionOptionById(req.params.id, next)
      .then(result => res.send(result))
      .catch(next)
  )
