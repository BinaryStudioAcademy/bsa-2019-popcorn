...
export class SeedSurveys1565789734851 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        const { data } = await getCustomRepository(UserRepository).getUserById('7f13634d-c353-433c-98fe-ead99e1252c7');
        ...
        surveysQuestion1.image = 'https://images.pexels.com/photos/459225/pexels-photo-459225.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500';
        ...
        await getCustomRepository(SurveysQuestionOptionRepository).save(surveysQuestionOption1);
        ...
        await getCustomRepository(SurveysQuestionOptionRepository).save(surveysQuestionOption11);
        ...
        await getCustomRepository(SurveysQuestionOptionRepository).save(surveysQuestionOption12);
        ...
        await getCustomRepository(SurveysQuestionAnswerRepository).save(surveysQuestionAnswer1);
        ...
        await getCustomRepository(SurveysQuestionAnswerRepository).save(surveysQuestionAnswer2);
        ...
        surveysQuestion3.image = 'https://images.pexels.com/photos/459225/pexels-photo-459225.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500';
        ...
        await getCustomRepository(SurveysQuestionOptionRepository).save(surveysQuestionOption2);
        ...
        await getCustomRepository(SurveysQuestionOptionRepository).save(surveysQuestionOption21);
        ...
        await getCustomRepository(SurveysQuestionAnswerRepository).save(surveysQuestionAnswer3);
        ...
        surveysQuestion4.image = 'https://apps.shopifycdn.com/listing_images/9d449ae9a7b5bf7bf43384f9c2928478/icon/ff93e6ee0fad4dce532e720f42946825.png';
        ...
        await getCustomRepository(SurveysQuestionOptionRepository).save(surveysQuestionOption3);
        ...
        await getCustomRepository(SurveysQuestionOptionRepository).save(surveysQuestionOption31);
        ...
        await getCustomRepository(SurveysQuestionAnswerRepository).save(surveysQuestionAnswer4);
    }
