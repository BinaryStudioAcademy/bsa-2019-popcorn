...
export class SeedStory1565606634607 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        for (let i = 0; i < 100; i++) {
            ...
            story.user = await getCustomRepository(UserRepository).findOne("7f13634d-c353-433c-98fe-ead99e1252c7");
            await getCustomRepository(StoryRepository)
                .save(story);
        }
    }
