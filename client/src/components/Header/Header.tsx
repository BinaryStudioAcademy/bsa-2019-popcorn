...
const ArrowDown = () => {
    return (
        <svg className="arrowDown " width="8" height="5" viewBox="0 0 8 5" fillOpacity="none" xmlns="http://www.w3.org/2000/svg">
...
const SearchIcon = () => {
    return (
        <svg className="searchIcon hover" width="14" height="14" viewBox="0 0 14 14" fillOpacity="none" xmlns="http://www.w3.org/2000/svg">
...
const MessageIcon = () => {
    return (
        <svg className="messageIcon hover" width="19" height="13" viewBox="0 0 19 13" fillOpacity="none" xmlns="http://www.w3.org/2000/svg">
...
const NotifyIcon = () => {
    return (
        <div className="notifyIcon hover"> <svg width="14" height="15" viewBox="0 0 14 15" fillOpacity="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg width="6" height="3" viewBox="0 0 6 3" fillOpacity="none" xmlns="http://www.w3.org/2000/svg">
...
const Header = ({ userInfo=user, movies = mock, tv = mock, ratings = mock }: IProps) => {
    return (
        <div className="header">
            ...
            <ArrowDown />
                <div className="modal">
                    {movies.map(movie => <div className="hover">{movie}</div>)}
                </div>
            </button>
            ...
            <ArrowDown />
                <div className="modal">
                    {tv.map(tvElemenet => <div className="inactive">{tvElemenet}</div>)}
                </div>
            </button>
            <button className="headerButtons hover">
                Ratings
            <ArrowDown />
                <div className="modal">
                    {ratings.map(rating => <div className="inactive">{rating}</div>)}
                </div>
            </button>
