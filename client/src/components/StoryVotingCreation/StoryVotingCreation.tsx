...
class StoryVotingCreation extends React.Component<{ uploadImage:(data:any)=>any }, StoryVotingCreationState> {
    constructor(props) {
        super(props);
        this.state = {
            header: "",
    ...
    handleShowPreview = () => {
        if (this.state.inputs.filter((el) => el.text == "").length === 0 && this.state.header !== "")
            this.setState({
                ...this.state,
    ...
    render() {
        ...
        <div className='image-uploading'>
            ...
            <button type="button"
                ...
                onClick={this.handleShowPreview}>Show Preview</button>
