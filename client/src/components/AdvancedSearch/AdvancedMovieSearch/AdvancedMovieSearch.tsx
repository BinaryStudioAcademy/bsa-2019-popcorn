...
const mockedCast = ['Brad Pitt', 'Tom Cruz', 'Keanu Revees', 'Robert Downey Jr.'];
...
class AdvancedMovieSearch extends React.Component<{}, AdvancedMovieSearchState> {
    ...
    render() {
        return <div className='advanced-movie-search'>
            <AdvancedSearchInputBlock handleSearchChange={this.handleDescriptionChange} header='Name'/>
            <AdvancedSearchCheckboxBlock checkboxHandler={this.handleGenreChange} values={mockedGenres} header='Genres' />
            <AdvancedSearchSliderBlock rangeHandler={this.handleYearChange} min={0} max={5} step={0.1} header='Year' />
            <AdvancedSearchCheckboxBlock checkboxHandler={this.handleCrewChange} values={mockedCrew} header='Crew' />
            <AdvancedSearchCheckboxBlock checkboxHandler={this.handleCastChange} values={mockedCast} header='Cast' />
            <AdvancedSearchSliderBlock rangeHandler={this.handleRatingChange} min={0} max={5} step={0.1} header='Rating' />
            <AdvancedSearchInputBlock handleSearchChange={this.handleDescriptionChange} header='Description'/>
            <AdvancedSearchSliderBlock rangeHandler={this.handleDurationChange} min={0} max={240} step={1} header='Duration' />
