...
class AdvancedSearchCheckboxBlock extends React.Component <AdvancedSearchvaluesProps, AdvancedSearchCheckboxBlockState> {
    constructor(props){
        super(props);
        this.state={
            valuesSearchValue:'',
    ...
    handleSearchChange=(e)=>{
        const filteredValues = this.props.values.filter(el=>el.includes(e.target.value));
        this.setState({
    ...
    return <div className='advanced-movie-search-block'>
        ...
        <input type='text' value={this.state.valuesSearchValue} onChange={this.handleSearchChange} className='checkbox-input' placeholder={`Search for a ${this.props.header}`}></input>
