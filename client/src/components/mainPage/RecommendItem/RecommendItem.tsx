...
const RecommendItem = ({ recommendItem: { image, name, date, rating } }: RecommendItemProps) => {
        ...
        <div className='recommend-item-info'>
            ...
            <div className='recommend-item-row'>
                <div className='recommend-item-action-buttons'>
                    <button><LikeIcon width='1.5em' height='1.5em' /></button>
                    <button><PlusIcon width='1.5em' height='1.5em' /></button>
                </div>
                <div>
