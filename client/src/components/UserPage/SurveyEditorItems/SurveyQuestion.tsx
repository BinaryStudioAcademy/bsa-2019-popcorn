...
import { faTimes, faTrashAlt, faCopy, faImage } from '@fortawesome/free-solid-svg-icons';
                ...
                <div>
                    <div className="type-title">
                        <input 
                                ...
                                onChange={(event) => { this.changeQuestionTitle(event) }} 
                    ...
                    <label className="question-required">
                        ...
                        <input 
                            ...
                            onChange={() => { this.changeRequirement() }} 
                        />
                    ...
                    <div className="sidebar-icons">
                        <p onClick={() => {duplicateQuestion(question)}}>
                            <FontAwesomeIcon title="Duplicate question" icon={faCopy} />
                        </p>
                        <p onClick={() => {deleteQuestion(question)}}>
                            <FontAwesomeIcon title="Delete question" icon={faTrashAlt} />
                        </p>
                        <input
                            name='image'
                            type='file'
                            onChange={(ev) => { this.handleUploadFile(ev) }}
