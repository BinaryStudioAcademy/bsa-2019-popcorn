...
const TopConstructor: React.FC<ITopConstructorProps> = ({ saveTop, moviesList }) => {
    ...
    function saveMovie(updatedMovie: IMovie) {
        let updatedMovies = movies.map(movie => movie.id === updatedMovie.id ? updatedMovie : movie);
    ...
    return (
        <div className="top-constructor">
            ...
            <div className="top-buttons-container">
                <div className='top-buttons hover'
                    onClick={() => setMovies([...movies, emptyInput])}>Add film</div>
                <div className="top-buttons save-top-button hover" onClick={save}>Save</div>
            </div>
        </div >
