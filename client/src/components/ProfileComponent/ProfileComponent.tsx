			...
			<div className="UserProfileComponent">
				...
				<div className="ProfileWrap">
					<div className="profilePhotoWrap">
						<UserLogo profileInfo={this.props.profileInfo}/>
					...
					<div className="ProfileInfo">
						...
						<div className="profileRow">
							...
							{ male && <p className="content">Male</p> }
							{ female && <p className="content">Female</p> }
						</div>
						<div className="profileRow">
						...
						<div className="profileRow">
							...
							<p className="content">
								<p>Cloud Atlas <span>&#10006;</span></p>
								<p>V for Vendetta <span>&#10006;</span></p>
								<p>Donnie Darko <span>&#10006;</span></p>
								<p>The Talented Mr. Ripley <span>&#10006;</span></p>
								<p>&#x2795;</p>
							</p>
						</div>
						<div className="profileRow">
							...
							<p className="content">
								<p>Stranger Things <span>&#10006;</span></p>
								<p>Black Mirror <span>&#10006;</span></p>
								<p>Breaking Bad <span>&#10006;</span></p>
								<p>&#x2795;</p>
							</p>
						</div>
					</div>
